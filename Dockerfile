...
#docker build --platform linux/amd64  -t 172.16.4.62:5000/customer/corebanking-service-1:1.0.9 .
#docker push 172.16.4.62:5000/customer/corebanking-service-1:1.0.9
