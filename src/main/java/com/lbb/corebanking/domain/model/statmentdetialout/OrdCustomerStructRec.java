...
public class OrdCustomerStructRec {
    ...
    private String opt;
    private SwfAcctLineStructRec swfAcctLineStructRec;
    private String address;
    private String bic;
    private SwfCustomerIdStructRec swfCustomerIdStructRec;
    private SwfCustomerDetailsStructRec swfCustomerDetailsStructRec;
